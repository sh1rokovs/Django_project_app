"""
Django settings for mynewshop project.
...
SECRET_KEY = '2$fiyd!#=sec7zx%a@a_9!0q^i)hd@0*zfzqq!ht^34fyp1axt'
...
INSTALLED_APPS = [
    ...
    'adminapp',
    'social_django',
    'neworderapp.apps.NeworderappConfig',
]
...
WSGI_APPLICATION = 'mynewshop.wsgi.application'
...
SOCIAL_SECRETS_FILE = 'mynewshop/social_auth.json'
SOCIAL = {}
if os.path.exists(SOCIAL_SECRETS_FILE):
    with open('mynewshop/social_auth.json', 'r') as f:
        SOCIAL = json.load(f)
...
SOCIAL_AUTH_GOOGLE_OAUTH2_SCOPE = [
    'email', 'profile', 'openid', 'https://www.googleapis.com/auth/plus.login',
]
...
if os.name == 'posix':
    ...
    CACHE_MIDDLEWARE_KEY_PREFIX = 'mynewshop'
